...
<div class="wrapper" style="width: 900px;margin-top: 40px">
    ...
    <form id="addHouseForm" class="layui-form">
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                <button class="layui-btn" lay-submit lay-filter="editMyInfo" id="addHouseRecord-btn">现在发布</button>
...
<script>
    layui.use(['element','form','layer','upload'],function () {
        ...
        form.on("submit(editMyInfo)",function(data){
            $.post("editMyInfo",$("#addHouseForm").serialize(),function(res){
                if(res=="OK"){
