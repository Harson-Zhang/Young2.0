...
<table  onload="getLocalTime()" class="easyui-datagrid" id="coursesList" title="用户选课列表"
       data-options="singleSelect:true,collapsible:true,pagination:true,url:'${pageContext.request.contextPath}/courseselected/list',method:'get',pageSize:30,toolbar:toolbar">
    <thead>
    <tr>
        ...
        handler:function(){
            ...
            $.messager.confirm('确认','确定删除该评价吗？',function(r){
                if (r){
                    ...
                    $.post("${pageContext.request.contextPath}/clearEvaluation/" + uid +"/"+cid, function(data){
                        if(data.status == 200){
