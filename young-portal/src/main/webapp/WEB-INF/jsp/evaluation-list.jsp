...
<table class="easyui-datagrid" id="evaluationList" title="用户列表"
       data-options="singleSelect:true,collapsible:true,pagination:true,url:'${pageContext.request.contextPath}/evaluation/list',method:'get',pageSize:30,toolbar:toolbar">
    <thead>
    <tr>
    ...
    var toolbar = [{
        ...
        handler:function(){
            ...
            $.messager.confirm('确认','确定删除ID为 '+ids+' 的用户吗？',function(r){
                if (r){
                    var params = {"ids":ids};
                    $.post("${pageContext.request.contextPath}/rest/user/delete",params, function(data){
                        if(data.status == 200){
