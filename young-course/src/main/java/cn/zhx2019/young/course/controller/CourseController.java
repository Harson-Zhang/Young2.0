...
public class CourseController {
    ...
    public String findHouseByLike(HttpServletRequest request, String keywords) {
        ...
        String keyword_parse = null;
        keyword_parse = new String(keywords.getBytes(StandardCharsets.ISO_8859_1), StandardCharsets.UTF_8);
        request.getSession().setAttribute("key", keyword_parse);
        List<Course> findCourse = service.findCourseByLike(keyword_parse);
