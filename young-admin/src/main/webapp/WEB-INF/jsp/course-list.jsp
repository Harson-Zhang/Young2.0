...
<table class="easyui-datagrid" id="courseList" title="课程列表"
       data-options="singleSelect:true,collapsible:true,pagination:true,url:'${pageContext.request.contextPath}/course/list',method:'get',pageSize:30,toolbar:toolbar">
    <thead>
    <tr>
